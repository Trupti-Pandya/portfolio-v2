    ...
    <>
        ...
        <div className="hero-right">
          <div className="terminal-box">
            ...
            <div className="terminal-body">
              ...
              <div className="t-cmd"><span>$ </span>query --profile trupti_pandya<span className="blink"></span></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="section reveal" id="about">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "start" }}>
          ...
          <div>
            <p style={{ fontSize: "15px", color: "var(--muted)", lineHeight: 1.9, fontFamily: "var(--courier)", marginBottom: "20px" }}>MSc Cloud Computing graduate from the University of Leicester — shipping production-grade GenAI products that sit at the intersection of rigorous engineering and intuitive design.</p>
            ...
            <p style={{ fontSize: "15px", color: "var(--muted)", lineHeight: 1.9, fontFamily: "var(--courier)" }}>My design background is the unfair advantage — it means I speak both the language of engineers and the language of users.</p>
          </div>
        </div>
      </div>
